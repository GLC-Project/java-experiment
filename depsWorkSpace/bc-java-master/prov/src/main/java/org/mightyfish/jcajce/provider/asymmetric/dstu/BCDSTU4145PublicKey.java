...
import org.mightyfish.asn1.ua.DSTU4145BinaryField;
import org.mightyfish.asn1.ua.DSTU4145ECBinary;
import org.mightyfish.asn1.ua.DSTU4145NamedCurves;
import org.mightyfish.asn1.ua.DSTU4145Params;
import org.mightyfish.asn1.ua.DSTU4145PointEncoder;
import org.mightyfish.asn1.ua.UAObjectIdentifiers;
...
import org.mightyfish.jcajce.provider.asymmetric.util.KeyUtil;
...
import org.mightyfish.math.ec.custom.sec.SecP256K1Point;
import org.mightyfish.math.ec.custom.sec.SecP256R1Point;

public class BCDSTU4145PublicKey
    implements ECPublicKey, org.mightyfish.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private transient org.mightyfish.math.ec.ECPoint q;
    ...
    public BCDSTU4145PublicKey(
        org.mightyfish.jce.spec.ECPublicKeySpec spec)
    {
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                org.mightyfish.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public BCDSTU4145PublicKey(
        String algorithm,
        ECPublicKeyParameters params,
        org.mightyfish.jce.spec.ECParameterSpec spec)
    {
        ECDomainParameters dp = params.getParameters();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        org.mightyfish.jce.spec.ECParameterSpec spec = null;
        ...
        else
        {
            ...
            spec = new org.mightyfish.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
        }
    ...
    public org.mightyfish.jce.spec.ECParameterSpec getParameters()
    {
    ...
    public org.mightyfish.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
    ...
    public org.mightyfish.math.ec.ECPoint engineGetQ()
    {
        return q;
    }

    org.mightyfish.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec, withCompression);
