 ...
 * 
 *         <p>
 *         A FilteredBlock is used to relay a block with its transactions
 *         filtered using a {@link BloomFilter}. It consists of the block header
 *         and a {@link PartialMerkleTree} which contains the transactions which
 *         matched the filter.
 *         </p>
 */
public class FilteredBlock {

    BigInteger networkID = null, blockSize = null, transCounter = null;
    ...
    /**
     * Empty Constructor.. Creates a new filtered block without any assignments.
     */
     ...
     */
    public FilteredBlock(BlockHeader header1) {
	this.header = header1;
    }
     ...
     */
    public int compareTo(FilteredBlock anotherBlock) {
     ...
     * @return 0 if the blocks are equal, -1 otherwise
     */
    public int compareWithPrevOfParam(FilteredBlock anotherBlock) {
	Sha256Hash a = this.getHash();
     ...
     * @return 0 if the blocks are equal, -1 otherwise
     */
    public int compareWithPrevOfCur(FilteredBlock anotherBlock) {
