...
import org.mightyfish.asn1.cms.GCMParameters;
...
import org.mightyfish.crypto.modes.AEADBlockCipher;
import org.mightyfish.crypto.modes.CBCBlockCipher;
import org.mightyfish.crypto.modes.CCMBlockCipher;
import org.mightyfish.crypto.modes.CFBBlockCipher;
import org.mightyfish.crypto.modes.CTSBlockCipher;
import org.mightyfish.crypto.modes.EAXBlockCipher;
import org.mightyfish.crypto.modes.GCFBBlockCipher;
import org.mightyfish.crypto.modes.GCMBlockCipher;
import org.mightyfish.crypto.modes.GOFBBlockCipher;
import org.mightyfish.crypto.modes.OCBBlockCipher;
import org.mightyfish.crypto.modes.OFBBlockCipher;
import org.mightyfish.crypto.modes.OpenPGPCFBBlockCipher;
import org.mightyfish.crypto.modes.PGPCFBBlockCipher;
import org.mightyfish.crypto.modes.SICBlockCipher;
import org.mightyfish.crypto.paddings.BlockCipherPadding;
import org.mightyfish.crypto.paddings.ISO10126d2Padding;
import org.mightyfish.crypto.paddings.ISO7816d4Padding;
import org.mightyfish.crypto.paddings.PaddedBufferedBlockCipher;
import org.mightyfish.crypto.paddings.TBCPadding;
import org.mightyfish.crypto.paddings.X923Padding;
import org.mightyfish.crypto.paddings.ZeroBytePadding;
import org.mightyfish.crypto.params.AEADParameters;
...
import org.mightyfish.crypto.params.RC2Parameters;
import org.mightyfish.crypto.params.RC5Parameters;
import org.mightyfish.jcajce.spec.GOST28147ParameterSpec;
import org.mightyfish.jcajce.spec.RepeatedSecretKeySpec;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        org.mightyfish.crypto.BlockCipher engine,
        int ivLength)
    {
        baseEngine = engine;
    ...
    static private interface GenericBlockCipher
    {
        ...
        public org.mightyfish.crypto.BlockCipher getUnderlyingCipher();
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(org.mightyfish.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(org.mightyfish.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
