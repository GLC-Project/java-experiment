package org.mightyfish.crypto.test.speedy;
...
import org.mightyfish.crypto.params.TweakableBlockCipherParameters;
...
//        speedTestCipher(new BlowfishEngine(), input);
    ...
    private static void runTestVector(String name, byte[] key, byte[] tweak, byte[] plaintext, byte[] expected, BlockCipher cipher)
    {
        ...
        System.out.println("  Encrypt  : " + org.mightyfish.util.Arrays.areEqual(expected, ciphertext));
        ...
        System.out.println("  Decrypt  : " + org.mightyfish.util.Arrays.areEqual(plaintext, replain));
    }
