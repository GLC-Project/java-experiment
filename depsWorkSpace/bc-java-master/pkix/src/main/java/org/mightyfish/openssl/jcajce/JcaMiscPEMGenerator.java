...
import org.mightyfish.cert.jcajce.JcaX509AttributeCertificateHolder;
import org.mightyfish.cert.jcajce.JcaX509CRLHolder;
import org.mightyfish.cert.jcajce.JcaX509CertificateHolder;
import org.mightyfish.jce.PKCS10CertificationRequest;
import org.mightyfish.openssl.MiscPEMGenerator;
import org.mightyfish.openssl.PEMEncryptor;
import org.mightyfish.x509.X509AttributeCertificate;
import org.mightyfish.x509.X509V2AttributeCertificate;
    ...
    extends MiscPEMGenerator
{
        ...
        throws IOException
    {
        ...
        {
            return new org.mightyfish.pkcs.PKCS10CertificationRequest(((PKCS10CertificationRequest)o).getEncoded());
        }
