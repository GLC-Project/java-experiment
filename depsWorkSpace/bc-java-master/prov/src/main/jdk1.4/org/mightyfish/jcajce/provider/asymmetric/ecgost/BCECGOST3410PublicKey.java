    ...
    implements ECPublicKey, ECPointEncoder
{
    ...
    public org.mightyfish.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof org.mightyfish.math.ec.ECPoint.Fp)
            {
                return new org.mightyfish.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new org.mightyfish.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
