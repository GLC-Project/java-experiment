    ...
    extends Signature
{
    ...
    private org.mightyfish.crypto.signers.PSSSigner pss;
        ...
        int trailerField)
    {
        if (trailerField == 1)
        {
            return org.mightyfish.crypto.signers.PSSSigner.TRAILER_IMPLICIT;
        }
        ...
        throws InvalidKeyException
    {
        ...
        {
            pss = new org.mightyfish.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength);
            pss.init(false,
                sigParams);
        }
    }
        ...
        throws SignatureException
    {
        try
        {
            if (isRaw)
            {
                ...
                pss = new org.mightyfish.crypto.signers.PSSSigner(signer, new NullPssDigest(contentDigest), mgfDigest, saltLength);
