...
import org.mightyfish.asn1.DERObjectIdentifier;
...
{
    private org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo infoObj;
        ...
        throws NullPointerException, IOException
    {
        ...
        infoObj = org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance((ASN1Sequence)dIn.readObject());
        ...
        throws NullPointerException, IllegalArgumentException, NoSuchAlgorithmException
    {
        ...
        org.mightyfish.asn1.x509.AlgorithmIdentifier      kAlgId = new AlgorithmIdentifier(new DERObjectIdentifier(algName), null);

        infoObj = new org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, (byte[])encryptedData.clone());
        algP = this.getParameters();
    }
        ...
        throws NullPointerException, IllegalArgumentException, NoSuchAlgorithmException
    {
        ...
        org.mightyfish.asn1.x509.AlgorithmIdentifier      kAlgId = null;
