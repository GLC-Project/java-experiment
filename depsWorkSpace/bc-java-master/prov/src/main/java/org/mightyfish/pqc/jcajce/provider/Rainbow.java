package org.mightyfish.pqc.jcajce.provider;
...
import org.mightyfish.pqc.jcajce.provider.rainbow.RainbowKeyFactorySpi;

public class Rainbow
{
    private static final String PREFIX = "org.mightyfish.pqc.jcajce.provider" + ".rainbow.";
