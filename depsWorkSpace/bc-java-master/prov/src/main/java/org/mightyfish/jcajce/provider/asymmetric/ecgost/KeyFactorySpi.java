    ...
    extends BaseKeyFactorySpi
{
        ...
        throws InvalidKeySpecException
    {
       ...
       else if (spec.isAssignableFrom(org.mightyfish.jce.spec.ECPublicKeySpec.class) && key instanceof ECPublicKey)
       {
           ECPublicKey k = (ECPublicKey)key;
           if (k.getParams() != null)
           {
               return new org.mightyfish.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW(), false), EC5Util.convertSpec(k.getParams(), false));
           }
           else
           {
               ECParameterSpec implicitSpec = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();

               return new org.mightyfish.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW(), false), implicitSpec);
           }
       }
       else if (spec.isAssignableFrom(org.mightyfish.jce.spec.ECPrivateKeySpec.class) && key instanceof ECPrivateKey)
       {
           ...
           if (k.getParams() != null)
           {
               return new org.mightyfish.jce.spec.ECPrivateKeySpec(k.getS(), EC5Util.convertSpec(k.getParams(), false));
           }
           else
           {
               ECParameterSpec implicitSpec = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();

               return new org.mightyfish.jce.spec.ECPrivateKeySpec(k.getS(), implicitSpec);
           }
       }
