...
public class TlsUtils
{
    ...
    static void validateKeyUsage(org.mightyfish.asn1.x509.Certificate c, int keyUsageBits)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        org.mightyfish.asn1.x509.Certificate x509Cert = clientCertificate.getCertificateAt(0);
