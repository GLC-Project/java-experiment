...
import org.mightyfish.asn1.smime.SMIMEEncryptionKeyPreferenceAttribute;
...
import org.mightyfish.mail.smime.SMIMEEnvelopedGenerator;
import org.mightyfish.mail.smime.SMIMEException;
...
public class SendSignedAndEncryptedMail
{
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            mailcap
                    .addMailcap("application/pkcs7-signature;; x-java-content-handler=org.mightyfish.mail.smime.handlers.pkcs7_signature");
            mailcap
                    .addMailcap("application/pkcs7-mime;; x-java-content-handler=org.mightyfish.mail.smime.handlers.pkcs7_mime");
            mailcap
                    .addMailcap("application/x-pkcs7-signature;; x-java-content-handler=org.mightyfish.mail.smime.handlers.x_pkcs7_signature");
            mailcap
                    .addMailcap("application/x-pkcs7-mime;; x-java-content-handler=org.mightyfish.mail.smime.handlers.x_pkcs7_mime");
            mailcap
                    .addMailcap("multipart/signed;; x-java-content-handler=org.mightyfish.mail.smime.handlers.multipart_signed");
