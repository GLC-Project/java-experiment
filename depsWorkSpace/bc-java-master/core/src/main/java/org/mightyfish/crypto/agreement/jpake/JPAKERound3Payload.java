package org.mightyfish.crypto.agreement.jpake;
...
public class JPAKERound3Payload
{
     ...
     *
     * @see JPAKEUtil#calculateMacTag(String, String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, org.mightyfish.crypto.Digest)
     */
