...
import org.mightyfish.jcajce.provider.asymmetric.ec.IESCipher;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        IESCipher c1 = new org.mightyfish.jcajce.provider.asymmetric.ec.IESCipher.ECIES();
        IESCipher c2 = new org.mightyfish.jcajce.provider.asymmetric.ec.IESCipher.ECIES();
        ...
        c1 = new org.mightyfish.jcajce.provider.asymmetric.ec.IESCipher.ECIESwithAES();
        c2 = new org.mightyfish.jcajce.provider.asymmetric.ec.IESCipher.ECIESwithAES();
        params = new IESParameterSpec(derivation, encoding, 128, 128);
