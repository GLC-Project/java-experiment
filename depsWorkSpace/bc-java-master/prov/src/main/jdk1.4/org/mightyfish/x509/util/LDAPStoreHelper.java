...
import org.mightyfish.jce.provider.X509AttrCertParser;
import org.mightyfish.jce.provider.X509CRLParser;
import org.mightyfish.jce.provider.X509CertPairParser;
import org.mightyfish.jce.provider.X509CertParser;
...
import org.mightyfish.x509.X509CertPairStoreSelector;
import org.mightyfish.x509.X509CertStoreSelector;
import org.mightyfish.x509.X509CertificatePair;
 ...
 * {@link org.mightyfish.jce.X509LDAPCertStoreParameters} with the given
 * information of the subject (for all kind of certificates) or issuer (for
 * CRLs), respectively, if a {@link org.mightyfish.x509.X509CertStoreSelector} or
 * {@link org.mightyfish.x509.X509AttributeCertificate} is given with that
 * details.
 * <p/>
...
public class LDAPStoreHelper
{
     ...
     * {@link org.mightyfish.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.
