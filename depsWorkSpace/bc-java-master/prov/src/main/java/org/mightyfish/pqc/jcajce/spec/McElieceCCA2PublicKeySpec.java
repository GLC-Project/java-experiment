 ...
 *
 * @see org.mightyfish.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PublicKey
 */
    ...
    implements KeySpec
{
    ...
    /**
     * Constructor (used by {@link org.mightyfish.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi}).
     *
     * @param n         length of the code
