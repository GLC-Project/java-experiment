...
import org.mightyfish.crypto.tls.Certificate;
import org.mightyfish.crypto.tls.DefaultTlsAgreementCredentials;
import org.mightyfish.crypto.tls.DefaultTlsEncryptionCredentials;
import org.mightyfish.crypto.tls.DefaultTlsSignerCredentials;
import org.mightyfish.crypto.tls.SignatureAndHashAlgorithm;
import org.mightyfish.crypto.tls.TlsAgreementCredentials;
import org.mightyfish.crypto.tls.TlsContext;
import org.mightyfish.crypto.tls.TlsEncryptionCredentials;
...
import org.mightyfish.util.io.pem.PemObject;
import org.mightyfish.util.io.pem.PemReader;
...
public class TlsTestUtils
{
    ...
    static String fingerprint(org.mightyfish.asn1.x509.Certificate c)
        throws IOException
    {
    ...
    static Certificate loadCertificateChain(String[] resources)
        throws IOException
    {
        org.mightyfish.asn1.x509.Certificate[] chain = new org.mightyfish.asn1.x509.Certificate[resources.length];
    ...
    static org.mightyfish.asn1.x509.Certificate loadCertificateResource(String resource)
        throws IOException
    {
        PemObject pem = loadPemResource(resource);
        if (pem.getType().endsWith("CERTIFICATE"))
        {
            return org.mightyfish.asn1.x509.Certificate.getInstance(pem.getContent());
        }
