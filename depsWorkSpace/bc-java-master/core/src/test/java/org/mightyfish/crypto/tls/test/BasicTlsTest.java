...
import org.mightyfish.crypto.tls.CipherSuite;
import org.mightyfish.crypto.tls.DefaultTlsClient;
import org.mightyfish.crypto.tls.ServerOnlyTlsAuthentication;
import org.mightyfish.crypto.tls.TlsAuthentication;
import org.mightyfish.crypto.tls.TlsClient;
import org.mightyfish.crypto.tls.TlsClientProtocol;
import org.mightyfish.crypto.tls.TlsFatalAlert;
import org.mightyfish.crypto.tls.TlsKeyExchange;
        ...
        throws Exception
    {
        ...
        keyExchange
            .processServerCertificate(new Certificate(
                new org.mightyfish.asn1.x509.Certificate[]{org.mightyfish.asn1.x509.Certificate
                    .getInstance(encCert)}));
    }
