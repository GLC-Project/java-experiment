...
import org.mightyfish.mail.smime.SMIMEEnveloped;
...
import org.mightyfish.mail.smime.util.FileBackedMimeBodyPart;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        assertTrue(org.mightyfish.util.Arrays.areEqual(testMessage, content));
    }
