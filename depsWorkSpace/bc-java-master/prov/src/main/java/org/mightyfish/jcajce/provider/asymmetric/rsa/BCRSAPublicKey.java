    ...
    implements RSAPublicKey
{
    ...
    private void populateFromPublicKeyInfo(SubjectPublicKeyInfo info)
    {
        try
        {
            org.mightyfish.asn1.pkcs.RSAPublicKey  pubKey = org.mightyfish.asn1.pkcs.RSAPublicKey.getInstance(info.parsePublicKey());
    ...
    {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(algorithmIdentifier, new org.mightyfish.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
