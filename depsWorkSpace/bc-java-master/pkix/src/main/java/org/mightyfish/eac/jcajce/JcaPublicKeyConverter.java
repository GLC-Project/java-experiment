package org.mightyfish.eac.jcajce;
...
public class JcaPublicKeyConverter
{
    ...
    private static org.mightyfish.math.ec.ECPoint convertPoint(
        ECCurve curve,
