package org.mightyfish.jcajce.provider.keystore.pkcs12;
...
import org.mightyfish.asn1.BEROutputStream;
...
import org.mightyfish.asn1.pkcs.EncryptedData;
...
import org.mightyfish.asn1.x509.Extension;
import org.mightyfish.asn1.x509.SubjectKeyIdentifier;
import org.mightyfish.asn1.x509.SubjectPublicKeyInfo;
import org.mightyfish.asn1.x509.X509ObjectIdentifiers;
import org.mightyfish.crypto.Digest;
import org.mightyfish.crypto.digests.SHA1Digest;
import org.mightyfish.jcajce.provider.config.PKCS12StoreParameter;
import org.mightyfish.jcajce.provider.symmetric.util.BCPBEKey;
import org.mightyfish.jcajce.spec.GOST28147ParameterSpec;
import org.mightyfish.jcajce.spec.PBKDF2KeySpec;
import org.mightyfish.jce.interfaces.BCKeyStore;
import org.mightyfish.jce.interfaces.PKCS12BagAttributeCarrier;
import org.mightyfish.jce.provider.BouncyCastleProvider;
import org.mightyfish.jce.provider.JDKPKCS12StoreParameter;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo eIn = org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.mightyfish.asn1.pkcs.PrivateKeyInfo kInfo = org.mightyfish.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
