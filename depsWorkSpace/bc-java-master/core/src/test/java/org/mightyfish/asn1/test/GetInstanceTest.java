...
import org.mightyfish.asn1.ASN1GeneralizedTime;
...
import org.mightyfish.asn1.ASN1TaggedObject;
import org.mightyfish.asn1.ASN1UTCTime;
...
import org.mightyfish.asn1.cmp.CAKeyUpdAnnContent;
import org.mightyfish.asn1.cmp.CMPCertificate;
import org.mightyfish.asn1.cmp.CRLAnnContent;
import org.mightyfish.asn1.cmp.CertConfirmContent;
import org.mightyfish.asn1.cmp.CertOrEncCert;
import org.mightyfish.asn1.cmp.CertRepMessage;
import org.mightyfish.asn1.cmp.CertResponse;
import org.mightyfish.asn1.cmp.CertifiedKeyPair;
import org.mightyfish.asn1.cmp.Challenge;
import org.mightyfish.asn1.cmp.ErrorMsgContent;
import org.mightyfish.asn1.cmp.GenMsgContent;
import org.mightyfish.asn1.cmp.GenRepContent;
import org.mightyfish.asn1.cmp.InfoTypeAndValue;
import org.mightyfish.asn1.cmp.KeyRecRepContent;
import org.mightyfish.asn1.cmp.OOBCertHash;
import org.mightyfish.asn1.cmp.PBMParameter;
import org.mightyfish.asn1.cmp.PKIBody;
import org.mightyfish.asn1.cmp.PKIConfirmContent;
import org.mightyfish.asn1.cmp.PKIFailureInfo;
import org.mightyfish.asn1.cmp.PKIFreeText;
import org.mightyfish.asn1.cmp.PKIHeader;
import org.mightyfish.asn1.cmp.PKIMessage;
import org.mightyfish.asn1.cmp.PKIMessages;
import org.mightyfish.asn1.cmp.PKIStatus;
import org.mightyfish.asn1.cmp.PKIStatusInfo;
import org.mightyfish.asn1.cmp.POPODecKeyChallContent;
import org.mightyfish.asn1.cmp.POPODecKeyRespContent;
import org.mightyfish.asn1.cmp.PollRepContent;
import org.mightyfish.asn1.cmp.PollReqContent;
import org.mightyfish.asn1.cmp.ProtectedPart;
import org.mightyfish.asn1.cmp.RevAnnContent;
import org.mightyfish.asn1.cmp.RevDetails;
import org.mightyfish.asn1.cmp.RevRepContent;
import org.mightyfish.asn1.cmp.RevReqContent;
import org.mightyfish.asn1.cms.Attribute;
import org.mightyfish.asn1.cms.Attributes;
import org.mightyfish.asn1.cms.AuthEnvelopedData;
import org.mightyfish.asn1.cms.AuthenticatedData;
import org.mightyfish.asn1.cms.CompressedData;
import org.mightyfish.asn1.cms.ContentInfo;
import org.mightyfish.asn1.cms.EncryptedContentInfo;
import org.mightyfish.asn1.cms.EncryptedData;
import org.mightyfish.asn1.cms.EnvelopedData;
import org.mightyfish.asn1.cms.Evidence;
import org.mightyfish.asn1.cms.IssuerAndSerialNumber;
import org.mightyfish.asn1.cms.KEKIdentifier;
import org.mightyfish.asn1.cms.KEKRecipientInfo;
import org.mightyfish.asn1.cms.KeyAgreeRecipientIdentifier;
import org.mightyfish.asn1.cms.KeyAgreeRecipientInfo;
import org.mightyfish.asn1.cms.KeyTransRecipientInfo;
import org.mightyfish.asn1.cms.MetaData;
import org.mightyfish.asn1.cms.OriginatorIdentifierOrKey;
import org.mightyfish.asn1.cms.OriginatorInfo;
import org.mightyfish.asn1.cms.OriginatorPublicKey;
import org.mightyfish.asn1.cms.OtherKeyAttribute;
import org.mightyfish.asn1.cms.OtherRecipientInfo;
import org.mightyfish.asn1.cms.PasswordRecipientInfo;
...
import org.mightyfish.asn1.cms.SignerIdentifier;
import org.mightyfish.asn1.cms.SignerInfo;
...
import org.mightyfish.asn1.crmf.AttributeTypeAndValue;
import org.mightyfish.asn1.crmf.CertId;
import org.mightyfish.asn1.crmf.CertReqMessages;
import org.mightyfish.asn1.crmf.CertReqMsg;
import org.mightyfish.asn1.crmf.CertRequest;
import org.mightyfish.asn1.crmf.CertTemplate;
import org.mightyfish.asn1.crmf.Controls;
import org.mightyfish.asn1.crmf.EncKeyWithID;
import org.mightyfish.asn1.crmf.EncryptedKey;
import org.mightyfish.asn1.crmf.EncryptedValue;
import org.mightyfish.asn1.crmf.OptionalValidity;
import org.mightyfish.asn1.crmf.PKIArchiveOptions;
import org.mightyfish.asn1.crmf.PKIPublicationInfo;
import org.mightyfish.asn1.crmf.PKMACValue;
import org.mightyfish.asn1.crmf.POPOPrivKey;
import org.mightyfish.asn1.crmf.POPOSigningKey;
import org.mightyfish.asn1.crmf.POPOSigningKeyInput;
import org.mightyfish.asn1.crmf.ProofOfPossession;
import org.mightyfish.asn1.crmf.SinglePubInfo;
import org.mightyfish.asn1.cryptopro.ECGOST3410ParamSetParameters;
import org.mightyfish.asn1.cryptopro.GOST28147Parameters;
import org.mightyfish.asn1.cryptopro.GOST3410ParamSetParameters;
import org.mightyfish.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
import org.mightyfish.asn1.eac.CVCertificate;
import org.mightyfish.asn1.eac.CVCertificateRequest;
import org.mightyfish.asn1.eac.CertificateBody;
import org.mightyfish.asn1.eac.PublicKeyDataObject;
import org.mightyfish.asn1.eac.RSAPublicKey;
import org.mightyfish.asn1.eac.UnsignedInteger;
import org.mightyfish.asn1.esf.CommitmentTypeIndication;
import org.mightyfish.asn1.esf.CommitmentTypeQualifier;
import org.mightyfish.asn1.esf.CompleteRevocationRefs;
import org.mightyfish.asn1.esf.CrlIdentifier;
import org.mightyfish.asn1.esf.CrlListID;
import org.mightyfish.asn1.esf.CrlOcspRef;
import org.mightyfish.asn1.esf.CrlValidatedID;
import org.mightyfish.asn1.esf.OcspIdentifier;
import org.mightyfish.asn1.esf.OcspListID;
import org.mightyfish.asn1.esf.OcspResponsesID;
import org.mightyfish.asn1.esf.OtherHash;
import org.mightyfish.asn1.esf.OtherHashAlgAndValue;
import org.mightyfish.asn1.esf.OtherRevRefs;
import org.mightyfish.asn1.esf.OtherRevVals;
import org.mightyfish.asn1.esf.RevocationValues;
import org.mightyfish.asn1.esf.SPUserNotice;
import org.mightyfish.asn1.esf.SPuri;
import org.mightyfish.asn1.esf.SigPolicyQualifierInfo;
import org.mightyfish.asn1.esf.SigPolicyQualifiers;
import org.mightyfish.asn1.esf.SignaturePolicyId;
import org.mightyfish.asn1.esf.SignaturePolicyIdentifier;
import org.mightyfish.asn1.esf.SignerAttribute;
import org.mightyfish.asn1.esf.SignerLocation;
import org.mightyfish.asn1.ess.ContentHints;
import org.mightyfish.asn1.ess.ContentIdentifier;
import org.mightyfish.asn1.ess.ESSCertID;
import org.mightyfish.asn1.ess.ESSCertIDv2;
import org.mightyfish.asn1.ess.OtherCertID;
import org.mightyfish.asn1.ess.OtherSigningCertificate;
import org.mightyfish.asn1.ess.SigningCertificate;
import org.mightyfish.asn1.ess.SigningCertificateV2;
import org.mightyfish.asn1.icao.CscaMasterList;
import org.mightyfish.asn1.icao.DataGroupHash;
import org.mightyfish.asn1.icao.LDSSecurityObject;
import org.mightyfish.asn1.icao.LDSVersionInfo;
import org.mightyfish.asn1.isismtt.ocsp.CertHash;
import org.mightyfish.asn1.isismtt.ocsp.RequestedCertificate;
import org.mightyfish.asn1.isismtt.x509.AdditionalInformationSyntax;
import org.mightyfish.asn1.isismtt.x509.AdmissionSyntax;
import org.mightyfish.asn1.isismtt.x509.Admissions;
import org.mightyfish.asn1.isismtt.x509.DeclarationOfMajority;
import org.mightyfish.asn1.isismtt.x509.MonetaryLimit;
import org.mightyfish.asn1.isismtt.x509.NamingAuthority;
import org.mightyfish.asn1.isismtt.x509.ProcurationSyntax;
import org.mightyfish.asn1.isismtt.x509.ProfessionInfo;
import org.mightyfish.asn1.isismtt.x509.Restriction;
import org.mightyfish.asn1.misc.CAST5CBCParameters;
import org.mightyfish.asn1.misc.IDEACBCPar;
import org.mightyfish.asn1.mozilla.PublicKeyAndChallenge;
import org.mightyfish.asn1.ocsp.BasicOCSPResponse;
import org.mightyfish.asn1.ocsp.CertID;
import org.mightyfish.asn1.ocsp.CertStatus;
import org.mightyfish.asn1.ocsp.CrlID;
import org.mightyfish.asn1.ocsp.OCSPRequest;
import org.mightyfish.asn1.ocsp.OCSPResponse;
import org.mightyfish.asn1.ocsp.OCSPResponseStatus;
import org.mightyfish.asn1.ocsp.Request;
import org.mightyfish.asn1.ocsp.ResponderID;
import org.mightyfish.asn1.ocsp.ResponseBytes;
import org.mightyfish.asn1.ocsp.ResponseData;
import org.mightyfish.asn1.ocsp.RevokedInfo;
import org.mightyfish.asn1.ocsp.Signature;
import org.mightyfish.asn1.ocsp.SingleResponse;
import org.mightyfish.asn1.ocsp.TBSRequest;
import org.mightyfish.asn1.oiw.OIWObjectIdentifiers;
import org.mightyfish.asn1.pkcs.AuthenticatedSafe;
import org.mightyfish.asn1.pkcs.CertificationRequest;
import org.mightyfish.asn1.pkcs.CertificationRequestInfo;
import org.mightyfish.asn1.pkcs.DHParameter;
import org.mightyfish.asn1.pkcs.EncryptedPrivateKeyInfo;
import org.mightyfish.asn1.pkcs.MacData;
import org.mightyfish.asn1.pkcs.PBEParameter;
import org.mightyfish.asn1.pkcs.PBES2Parameters;
import org.mightyfish.asn1.pkcs.PBKDF2Params;
import org.mightyfish.asn1.pkcs.PKCS12PBEParams;
import org.mightyfish.asn1.pkcs.Pfx;
import org.mightyfish.asn1.pkcs.PrivateKeyInfo;
import org.mightyfish.asn1.pkcs.RC2CBCParameter;
import org.mightyfish.asn1.pkcs.RSAESOAEPparams;
import org.mightyfish.asn1.pkcs.RSAPrivateKey;
import org.mightyfish.asn1.pkcs.RSASSAPSSparams;
import org.mightyfish.asn1.pkcs.SafeBag;
import org.mightyfish.asn1.pkcs.SignedData;
import org.mightyfish.asn1.sec.ECPrivateKey;
import org.mightyfish.asn1.smime.SMIMECapabilities;
import org.mightyfish.asn1.smime.SMIMECapability;
import org.mightyfish.asn1.tsp.Accuracy;
import org.mightyfish.asn1.tsp.MessageImprint;
import org.mightyfish.asn1.tsp.TSTInfo;
import org.mightyfish.asn1.tsp.TimeStampReq;
import org.mightyfish.asn1.tsp.TimeStampResp;
import org.mightyfish.asn1.x500.DirectoryString;
import org.mightyfish.asn1.x500.RDN;
import org.mightyfish.asn1.x500.X500Name;
import org.mightyfish.asn1.x509.AccessDescription;
import org.mightyfish.asn1.x509.AlgorithmIdentifier;
import org.mightyfish.asn1.x509.AttCertIssuer;
import org.mightyfish.asn1.x509.AttCertValidityPeriod;
import org.mightyfish.asn1.x509.AttributeCertificate;
import org.mightyfish.asn1.x509.AttributeCertificateInfo;
import org.mightyfish.asn1.x509.AuthorityInformationAccess;
import org.mightyfish.asn1.x509.AuthorityKeyIdentifier;
import org.mightyfish.asn1.x509.BasicConstraints;
import org.mightyfish.asn1.x509.CRLDistPoint;
import org.mightyfish.asn1.x509.CRLNumber;
import org.mightyfish.asn1.x509.CRLReason;
import org.mightyfish.asn1.x509.Certificate;
import org.mightyfish.asn1.x509.CertificateList;
import org.mightyfish.asn1.x509.CertificatePair;
import org.mightyfish.asn1.x509.CertificatePolicies;
import org.mightyfish.asn1.x509.DSAParameter;
import org.mightyfish.asn1.x509.DigestInfo;
import org.mightyfish.asn1.x509.DisplayText;
import org.mightyfish.asn1.x509.DistributionPoint;
import org.mightyfish.asn1.x509.DistributionPointName;
import org.mightyfish.asn1.x509.ExtendedKeyUsage;
import org.mightyfish.asn1.x509.Extensions;
import org.mightyfish.asn1.x509.GeneralName;
import org.mightyfish.asn1.x509.GeneralNames;
import org.mightyfish.asn1.x509.GeneralSubtree;
import org.mightyfish.asn1.x509.Holder;
import org.mightyfish.asn1.x509.IetfAttrSyntax;
import org.mightyfish.asn1.x509.IssuerSerial;
import org.mightyfish.asn1.x509.IssuingDistributionPoint;
import org.mightyfish.asn1.x509.NameConstraints;
import org.mightyfish.asn1.x509.NoticeReference;
import org.mightyfish.asn1.x509.ObjectDigestInfo;
import org.mightyfish.asn1.x509.PolicyInformation;
import org.mightyfish.asn1.x509.PolicyMappings;
import org.mightyfish.asn1.x509.PolicyQualifierInfo;
import org.mightyfish.asn1.x509.PrivateKeyUsagePeriod;
import org.mightyfish.asn1.x509.RSAPublicKeyStructure;
import org.mightyfish.asn1.x509.RoleSyntax;
import org.mightyfish.asn1.x509.SubjectDirectoryAttributes;
import org.mightyfish.asn1.x509.SubjectKeyIdentifier;
import org.mightyfish.asn1.x509.SubjectPublicKeyInfo;
import org.mightyfish.asn1.x509.TBSCertList;
import org.mightyfish.asn1.x509.TBSCertificate;
import org.mightyfish.asn1.x509.TBSCertificateStructure;
import org.mightyfish.asn1.x509.Target;
import org.mightyfish.asn1.x509.TargetInformation;
import org.mightyfish.asn1.x509.Targets;
import org.mightyfish.asn1.x509.Time;
import org.mightyfish.asn1.x509.UserNotice;
import org.mightyfish.asn1.x509.V2Form;
import org.mightyfish.asn1.x509.X509CertificateStructure;
import org.mightyfish.asn1.x509.X509Extensions;
import org.mightyfish.asn1.x509.X509Name;
import org.mightyfish.asn1.x509.qualified.BiometricData;
import org.mightyfish.asn1.x509.qualified.Iso4217CurrencyCode;
import org.mightyfish.asn1.x509.qualified.MonetaryValue;
import org.mightyfish.asn1.x509.qualified.QCStatement;
import org.mightyfish.asn1.x509.qualified.SemanticsInformation;
import org.mightyfish.asn1.x509.qualified.TypeOfBiometricData;
import org.mightyfish.asn1.x509.sigi.NameOrPseudonym;
import org.mightyfish.asn1.x509.sigi.PersonalData;
import org.mightyfish.asn1.x9.DHDomainParameters;
import org.mightyfish.asn1.x9.DHPublicKey;
import org.mightyfish.asn1.x9.DHValidationParms;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        doFullGetInstanceTest(org.mightyfish.asn1.cmp.CertStatus.class, new org.mightyfish.asn1.cmp.CertStatus(new byte[10], BigInteger.valueOf(1), new PKIStatusInfo(PKIStatus.granted)));
        ...
        doFullGetInstanceTest(SignerAttribute.class, new SignerAttribute(new org.mightyfish.asn1.x509.Attribute[]{new org.mightyfish.asn1.x509.Attribute(new ASN1ObjectIdentifier("1.2.1"), new DERSet())}));
