 ...
 * </pre>
 *
 * @see org.mightyfish.asn1.x509.Certificate
 */
public class Certificate
{
    public static final Certificate EMPTY_CHAIN = new Certificate(
        new org.mightyfish.asn1.x509.Certificate[0]);

    protected org.mightyfish.asn1.x509.Certificate[] certificateList;

    public Certificate(org.mightyfish.asn1.x509.Certificate[] certificateList)
    {
    ...
    /**
     * @return an array of {@link org.mightyfish.asn1.x509.Certificate} representing a certificate
     *         chain.
     */
    public org.mightyfish.asn1.x509.Certificate[] getCertificateList()
    {
        return cloneCertificateList();
    }

    public org.mightyfish.asn1.x509.Certificate getCertificateAt(int index)
    {
        ...
        throws IOException
    {
        ...
        while (buf.available() > 0)
        {
            ...
            certificate_list.addElement(org.mightyfish.asn1.x509.Certificate.getInstance(asn1Cert));
        }

        org.mightyfish.asn1.x509.Certificate[] certificateList = new org.mightyfish.asn1.x509.Certificate[certificate_list.size()];
        for (int i = 0; i < certificate_list.size(); i++)
        {
            certificateList[i] = (org.mightyfish.asn1.x509.Certificate)certificate_list.elementAt(i);
        }
        return new Certificate(certificateList);
    }

    protected org.mightyfish.asn1.x509.Certificate[] cloneCertificateList()
    {
        org.mightyfish.asn1.x509.Certificate[] result = new org.mightyfish.asn1.x509.Certificate[certificateList.length];
