...
public class EC5Util
{
    ...
    public static org.mightyfish.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new org.mightyfish.jce.spec.ECParameterSpec(
            curve,
    ...
    public static org.mightyfish.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
