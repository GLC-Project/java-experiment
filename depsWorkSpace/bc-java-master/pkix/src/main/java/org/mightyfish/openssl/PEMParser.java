...
import org.mightyfish.util.io.pem.PemObjectParser;
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                org.mightyfish.asn1.sec.ECPrivateKey pKey = org.mightyfish.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                org.mightyfish.asn1.pkcs.RSAPrivateKey keyStruct = org.mightyfish.asn1.pkcs.RSAPrivateKey.getInstance(seq);
