...
import org.mightyfish.asn1.bc.BCObjectIdentifiers;
import org.mightyfish.asn1.cms.CCMParameters;
...
import org.mightyfish.crypto.engines.RFC5649WrapEngine;
...
import org.mightyfish.crypto.modes.*;
...
import org.mightyfish.jcajce.provider.symmetric.util.BaseAlgorithmParameters;
...
import org.mightyfish.jcajce.provider.symmetric.util.PBESecretKeyFactory;
...
public final class AES
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new org.mightyfish.crypto.macs.Poly1305(new AESFastEngine()));
        }
    }
