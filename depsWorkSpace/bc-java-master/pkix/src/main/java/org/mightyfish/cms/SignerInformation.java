...
import org.mightyfish.operator.RawContentVerifier;
...
public class SignerInformation
{
     ...
     * @throws org.mightyfish.cms.CMSVerifierCertificateNotValidException if the provider has an associated certificate and the certificate is not valid at the time given as the SignerInfo's signing time.
     * @throws org.mightyfish.cms.CMSException if the verifier is unable to create a ContentVerifiers or DigestCalculators.
     */
