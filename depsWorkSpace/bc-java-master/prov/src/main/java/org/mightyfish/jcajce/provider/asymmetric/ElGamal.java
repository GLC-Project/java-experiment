...
import org.mightyfish.jcajce.provider.asymmetric.elgamal.KeyFactorySpi;
...
{
    private static final String PREFIX = "org.mightyfish.jcajce.provider.asymmetric" + ".elgamal.";
