package org.mightyfish.jcajce.provider.asymmetric.ecgost;
...
import org.mightyfish.asn1.cryptopro.ECGOST3410NamedCurves;
...
import org.mightyfish.jcajce.provider.asymmetric.util.ECUtil;
import org.mightyfish.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
import org.mightyfish.jce.ECGOST3410NamedCurveTable;
...
public class BCECGOST3410PrivateKey
    implements ECPrivateKey, org.mightyfish.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCECGOST3410PrivateKey(
        org.mightyfish.jce.spec.ECPrivateKeySpec spec)
    {
        this.d = spec.getD();
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            {
                org.mightyfish.asn1.sec.ECPrivateKey ec = org.mightyfish.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        else
        {
            ...
            PrivateKeyInfo info;
            org.mightyfish.asn1.sec.ECPrivateKey keyStructure;

            if (publicKey != null)
            {
                keyStructure = new org.mightyfish.asn1.sec.ECPrivateKey(this.getS(), publicKey, params);
            }
            else
            {
                keyStructure = new org.mightyfish.asn1.sec.ECPrivateKey(this.getS(), params);
            }
