...
import org.mightyfish.jcajce.provider.asymmetric.ecgost.KeyFactorySpi;
...
public class ECGOST
{
    private static final String PREFIX = "org.mightyfish.jcajce.provider.asymmetric" + ".ecgost.";
